...
const ViewPassword = () => {
    ...
    const deletePass = (uid) => {
        ...
        if (confirmDelete) {
            dispatch(deletePasswordAsync(uid));
            navigate('/');
    ...
    return (
        <>
            ...
            <div style={{ height: "calc(100vh - 70px)" }}
                ...
                {loading || !selected  ? (<div className='p-1 sm:p-5 shadow-md border border-gray-300 rounded-2xl
                                flex justify-center bg-white'>Loading....</div>) : (
                    <>
                        {edit ? (<div className='p-1 sm:p-5 shadow-md border border-gray-300 rounded-2xl
                            ...
                            <div className='flex justify-center'>
                                ...
                                <button className='p-2 px-10 m-2 mr-5 rounded-full w-fit bg-yellow-300  hover:bg-yellow-400 hover:scale-105 transition-transform duration-200 ease-in-out' onClick={() => { dispatch(setForm({ title: "", site: "", username: "", password: "", note: "" })); setedit(false) }}>Cancel</button><br />
                            </div>
                            ...
                            <div className=' p-3 sm:p-10 shadow-md border border-gray-300 rounded-2xl 
                                ...
                                <div className='flex justify-center'>
                                    <button className='p-2 px-10 m-2 mr-5 rounded-full w-fit bg-yellow-300 hover:bg-yellow-400 hover:scale-105 transition-transform duration-200 ease-in-out' onClick={() => deletePass(selected._id)}>Delete</button>
